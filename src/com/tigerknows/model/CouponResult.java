...
public class CouponResult extends BaseData{
	...
	public CouponResult(XMap data) throws APIException {
		super(data);
		init(data, true);
	}
	...
	public static XMapInitializer<CouponResult> Initializer = new XMapInitializer<CouponResult>() {

        @Override
        public CouponResult init(XMap data) throws APIException {
