...
public class Yanchu extends BaseData implements Parcelable{
    ...
    // 0x05 x_string 演出详情 description
    ...
    // 0x19 x_string 订票电话 order_tel
    public static final byte FIELD_ORDER_TEL = 0x19;

    // 0x1a x_string 与当前位置的距离 实时生成
    public static final byte FIELD_DISTANCE = 0x1a;

    private String uid; // 0x00 x_string uid uid
    private String name; // 0x01 x_string 演出名称 name
    ...
    private String description; // 0x05 x_string 演出详情 description
    ...
    private String price; // 0x0b x_string 演出费用 price
    private String contactTel; // 0x0c x_string 联系电话 contact_tel
    private String placeName; // 0x0f x_string 演出地点名称 place_name
    private String address; // 0x10 x_string 演出地点地址 address
    ...
    private String orderTel; // 0x19 x_string 订票电话 order_tel
    private String distance; // 0x20 x_string 与当前位置的距离 实时生成
    ...
    public void init(XMap data, boolean reset) throws APIException {
        ...
        this.contactTel = getStringFromData(FIELD_CONTACT_TEL, reset ? null : this.contactTel);
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof Yanchu) {
            Yanchu other = (Yanchu) object;
    ...
    public void setPictures(TKDrawable pictures) {
    ...
    public static XMapInitializer<Yanchu> Initializer = new XMapInitializer<Yanchu>() {

        @Override
        public Yanchu init(XMap data) throws APIException {
            return new Yanchu(data);
        }
    };
}
