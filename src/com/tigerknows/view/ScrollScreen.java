...
public class ScrollScreen extends ViewGroup {
    ...
    private boolean slipLastScreen = false;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                break;
            case MotionEvent.ACTION_MOVE:// /²»Í¬
                final float x = ev.getX();
                final float deltaX = mLastMotionX - x;
                if ((mCurrentScreen == 0 && deltaX < 0) || (slipLastScreen == false && (getChildCount() - 1 == mCurrentScreen && deltaX > 0))) {
                    return true;
                }
    ...
    public void snapToDestination() {
        ...
        if (destScreen >= getChildCount()) {
            ...
            if (mOnScreenChangeListener != null) {
                mOnScreenChangeListener.onScreenChanged(-1);
            }
        } else {
    ...
    public void setSlipLastScreen(boolean slipLastScreen) {
        this.slipLastScreen = slipLastScreen;
    }
