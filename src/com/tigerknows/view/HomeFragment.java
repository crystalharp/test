...
public class HomeFragment extends BaseFragment implements View.OnClickListener {
    ...
    static final String ACTION_SUBCATEGORY_OP_TOUCH = "a";
    static final String ACTION_SUBCATEGORY_OP_BUTTON = "b";
    static final String ACTION_SUBCATEGORY_OP_BACK = "c";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSubCategoryAdapter = new ArrayAdapter<String>(mContext, R.layout.drag_view_item, new ArrayList<String>());
	...
	AnimationListener mDragOpenAnimationListener = new AnimationListener() {
		...
		public void onAnimationStart(Animation animation) {
			HomeFragment.this.animation = true;
		}
		...
		public void onAnimationEnd(Animation animation) {
			...
			HomeFragment.this.animation = false;
		}
	};
