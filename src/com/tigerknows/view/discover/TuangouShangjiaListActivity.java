 ...
 * @author Peng Wenyue
 */
public class TuangouShangjiaListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tuangou_shangjia_list);
    ...
    private class ResultAdapter extends ArrayAdapter<Shangjia>{
        private static final int TEXTVIEW_RESOURCE_ID = R.layout.tuangou_shangjia_list_item;
