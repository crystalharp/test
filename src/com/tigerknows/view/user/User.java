...
public class User implements Serializable {
    ...
    private static final String PREFS_KEY_NICKNAME = "UserNickName";
	...
	public void store(Context context) {
	    if (nickName != null) {
            TKConfig.setPref(context, PREFS_KEY_NICKNAME, new String(Base64.encode(nickName.getBytes(), Base64.DEFAULT)));
	...
	public static User loadDefault(Context context) {
		User user = null;
		try {
            String nickNameStr = TKConfig.getPref(context, PREFS_KEY_NICKNAME);
	...
	public void clear(Context context) {
		TKConfig.removePref(context, PREFS_KEY_NICKNAME);
