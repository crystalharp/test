...
public class Session implements Serializable{
    ...
    private static final String PREFS_KEY_TIMEOUT = "TimeOut";
	...
	public void store(Context context) {
	    if (mSessionId != null) {
            ...
            TKConfig.setPref(context, PREFS_KEY_TIMEOUT, new String(Base64.encode(String.valueOf(timeout).getBytes(), Base64.DEFAULT)));
	    }
	}
	...
	public static Session loadDefault(Context context) {
		...
		try {
			...
			String timeOutStr = TKConfig.getPref(context, PREFS_KEY_TIMEOUT);
	...
	public void clear(Context context) {
        ...
        TKConfig.removePref(context, PREFS_KEY_TIMEOUT);
	}
