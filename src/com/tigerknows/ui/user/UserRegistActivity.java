...
public class UserRegistActivity extends UserBaseActivity {
	...
	private void validationAction(final ExtValidationEditText source) {
		Utility.showNormalDialog(UserRegistActivity.this, getString(R.string.title_error_tip), source.msg, 
	...
	private void onSuccess() {
		...
		if (mSourceViewIdLogin != R.id.activity_poi_edit_comment) {
            ...
            Intent intent = new Intent(UserRegistActivity.this, EditCommentActivity.class);
	...
	private void dealWith402() {
		Utility.showNormalDialog(UserRegistActivity.this, getString(R.string.title_error_tip), getString(R.string.response_code_402), 
		        getString(R.string.confirm),
                null,
                new OnClickListener() {
	...
	private void dealWith503() {
		Utility.showNormalDialog(UserRegistActivity.this, getString(R.string.title_error_tip), getString(R.string.response_code_503), 
		        getString(R.string.confirm),
                null,
                new OnClickListener() {
