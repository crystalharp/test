...
//		mSuggestListManager = new SuggestWordListManager(mQueryFragment.mSphinx, mSuggestLsv, mQueryFragment.mStartBtn.getEdt(), inputBtnHandler, HistoryWordTable.TYPE_TRAFFIC);
//	}
//    
//	/**
//	 * 右侧输入按钮的点击响应事件
