...
/**
 * this file is auto generated by script/genViewId.py
 * please do not edit manually.
 * if you want to edit this file, edit the dict "IDs" in
 * the script file
 */
...
//----generate end----
    ...
    private static TKFragmentManager manager = null;
    
    private TKFragmentManager(Sphinx s) {
        mSphinx = s;
    }
    
    public static TKFragmentManager getInstance(Sphinx s) {
        if (manager == null) {
            manager = new TKFragmentManager(s);
        }
        return manager;
    }
    ...
    public final boolean hasCreatedFragment(int id) {
        return FragmentHashmap.containsKey(id);
    }
