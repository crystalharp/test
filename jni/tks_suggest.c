...
char cur_word[2];
int cilen, silen, csnum, clnum, ssnum, slnum, wordscount;//����Ⱥʹ������� 
FILE *csfp, *clfp, *ssfp, *slfp;             //����ʿ��ļ�ָ��
int cityv, nationv;
int nflag, cflag;
...
int set_context(const char* filepath, int citycode, int* version, FILE** sfp, FILE** lfp, Index** indexarray, int* indexlength)
{
    ...
    *version = 0;
    ...
    //�����ж�������ļ��������ԣ�����ļ���ֻҪ��һ�������ڣ���ȫ��ɾ��
    //�����ڣ���˵��index�ļ��������index���ж�_s,_l�����ļ��������ԣ�������������ȫ���ļ�
...
int tk_getwordslist(const char* searchword, unsigned int type, int *hit) 
{
    ...
    if (0 == count) {
        *hit = 0;
        /*
        suffixed = 0;
        //confirm whether the search word has  added the words such as "�͹�" 
        if (type == 1 || type == 2) {
